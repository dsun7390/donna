<template>
  <div
    class="block"
    :class="isActiveBlock ? 'active' : ''"
    @mouseup="handleBlockClick"
  >
          ...
          <ul>
            <li>
              <button-base
                ...
                :title="$t('builderBlock.duplicateBlock')"
    ...
    <text-area
      :placeholder="$t('builderBlock.typeDescription')"
      :block="block"
      @handleInput="updateBlockdescription"
    />
    <Container
    ...
    >
      ...
      >
        <builder-question
          ...
          :currentQuestion="block.questionData.currentQuestion"
          :question="question"
          :block="block"
        />
      </Draggable>
    ...
    <div class="container">
      <div class="popup" :class="newQuestion ? 'show above' : ''">
        ...
        <ul v-for="type in questionTypes" :key="type">
          <li>
            <button-base
              class="secondary min"
              :title="$t('builderBlock.'+type.toString().replace(/\s/g, ''))"
      ...
      <button-base
        class="primary standard popup-btn"
        :icon="'fas fa-plus fa-me'"
        :title="$t('builderBlock.addNewQuestion')"
        @buttonPress="pressNewQuestion"
